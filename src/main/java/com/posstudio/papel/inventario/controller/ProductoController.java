...
public class ProductoController {
    ...
    @GetMapping
    public ResponseEntity<PageResponseDTO<ProductoResponsiveDTO>> listar(
        ...
        ProductoFiltroDTO filtro = new ProductoFiltroDTO(nombre, categoria, ubicacion, codigoDeBarras);
        return ResponseEntity.ok(productoService.listarProducto(filtro, pagina, tamanio));
    }
